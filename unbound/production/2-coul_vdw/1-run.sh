...
#  if [ $lam -eq 7 ]; then 
  ...
  mkdir ENMIN
  cd ENMIN
  $gmx grompp -f ../../MDP/ENMIN/enmin.$lam.mdp -c ../../ligand.gro -p ../../ligand.top -o enmin.tpr -maxwarn 1 -r ../../ligand.gro
  $gmx mdrun -v -stepout 1000 -s enmin.tpr -deffnm enmin 

  cd ../
  mkdir NVT
  cd NVT
  $gmx grompp -f ../../MDP/NVT/nvt.$lam.mdp -c ../ENMIN/enmin.gro -p ../../ligand.top -o nvt.tpr -maxwarn 1 -r ../ENMIN/enmin.gro
  $gmx mdrun -stepout 1000 -s nvt.tpr -deffnm nvt -v 

  cd ../
  mkdir NPT
  cd NPT
  $gmx grompp -f ../../MDP/NPT/npt.$lam.mdp -c ../NVT/nvt.gro -t ../NVT/nvt.cpt -p ../../ligand.top -o npt.tpr -maxwarn 1 -r ../NVT/nvt.gro
  ...
  mkdir PROD
  cd PROD
  $gmx grompp -f ../../MDP/PROD/prod.$lam.mdp -c ../NPT/npt.gro -t ../NPT/npt.cpt -p ../../ligand.top -o prod.tpr -maxwarn 1
